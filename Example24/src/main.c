...
GLUSboolean init(GLUSvoid)
{
    ...
    if (!glusFileLoadText("../Example24/shader/erode.vert.glsl", &vertexSource))
    {
    ...
    if (!glusFileLoadText("../Example24/shader/erode.frag.glsl", &fragmentSource))
    {
    ...
    if (!glusShapeCreateSpheref(&sphere, 1.0f, 64))
    {
