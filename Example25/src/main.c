...
GLUSboolean init(GLUSvoid)
{
    ...
    if (!glusFileLoadText("../Example25/shader/phong_textured.vert.glsl", &vertexSource))
    {
    ...
    if (!glusFileLoadText("../Example25/shader/phong_textured.frag.glsl", &fragmentSource))
    {
