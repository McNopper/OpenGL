...
{
    return REC2020_TO_REC709 * c;
}
vec3 toDisplayP3(vec3 c)
{
    return REC2020_TO_DISPLAY_P3 * c;
}
...
vec3 hlgEncode3(vec3 E)
{
    return vec3(hlgEncode(E.r), hlgEncode(E.g), hlgEncode(E.b));
}
