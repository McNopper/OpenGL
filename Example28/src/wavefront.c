/**
 * OpenGL 3 - Example 28 - Rendering of the wavefront object
 *
...
GLUSboolean initWavefront(GLUSfloat viewMatrix[16], struct LightProperties* light)
{
    ...
    glusLoadTextFile("../Example28/shader/phong.vert.glsl", &vertexSource);
    glusLoadTextFile("../Example28/shader/phong.frag.glsl", &fragmentSource);
