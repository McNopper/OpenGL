...
GLUSvoid key(const GLUSboolean pressed, const GLUSint k)
{
    if (k == 'w')
    {
        g_moveForward = pressed;
    }
    if (k == 's')
    {
        g_moveBackward = pressed;
    }
    if (k == 'a')
    {
        g_strafeLeft = pressed;
    }
    if (k == 'd')
    {
        g_strafeRight = pressed;
    }
...
GLUSboolean update(GLUSfloat time)
{
    ...
    if (g_moveForward)
    {
        g_eye[0] += fwdX * moveSpeed;
        g_eye[2] += fwdZ * moveSpeed;
    }
    if (g_moveBackward)
    {
        g_eye[0] -= fwdX * moveSpeed;
...
GLUSvoid terminate(GLUSvoid)
{
    ...
    if (g_sphereIndicesVBO)
    {
        glDeleteBuffers(1, &g_sphereIndicesVBO);
        g_sphereIndicesVBO = 0;
    }
    if (g_sphereTexCoordsVBO)
    {
        glDeleteBuffers(1, &g_sphereTexCoordsVBO);
        g_sphereTexCoordsVBO = 0;
    }
    if (g_sphereNormalsVBO)
    {
        glDeleteBuffers(1, &g_sphereNormalsVBO);
        g_sphereNormalsVBO = 0;
    }
    if (g_sphereVerticesVBO)
    {
        glDeleteBuffers(1, &g_sphereVerticesVBO);
        g_sphereVerticesVBO = 0;
    }
